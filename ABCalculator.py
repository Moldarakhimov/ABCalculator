...
def do_processing():
    # Считывание данных их полей ввода
...
def popup_window(n1, c1, n2, c2):
    ...
    lblComment_95 = tk.Label(window, text = "95% уверенность:", font = ('Helvetica', 10, 'bold'))
    lblComment_95.place(x=25, y=25)
    
    if confidence_95:
        lblResult_95 = tk.Label(window, text = "ДА", font = ('Helvetica', 12, 'bold'), fg = '#008800')
        lblResult_95.place(x=160, y=25)
    else:
        lblResult_95 = tk.Label(window, text = "НЕТ", font = ('Helvetica', 12, 'bold'), fg = '#ff0000')
        lblResult_95.place(x=160, y=25)
    
    lblComment_99 = tk.Label(window, text = "99% уверенность:", font = ('Helvetica', 10, 'bold'))
    lblComment_99.place(x=25, y=65)
    
    if confidence_99:
        lblResult_99 = tk.Label(window, text = "ДА", font = ('Helvetica', 12, 'bold'), fg = '#008800')
        lblResult_99.place(x=160, y=65)
    else:
    ...
    # Перевод фокус на созданное окно
    window.focus_force()
